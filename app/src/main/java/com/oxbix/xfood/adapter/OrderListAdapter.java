...
public class OrderListAdapter extends BaseAdapter {
	...
	public OrderListAdapter(Context context, List<CustomerOrderItemDTO> data) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = layoutInflater.inflate(R.layout.new_order_list_item_layout, null);
		...
		viewHolder.getStartBtn().setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new WSClientImpl(context).updateOrderItemStatus(Config.getToken(context), data.get(_position).getId(), 1, 0, new StatusListener() {
