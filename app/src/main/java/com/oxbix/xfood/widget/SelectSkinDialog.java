...
import com.oxbix.xfood.adapter.DialogSelectSkinListAdapter;
...
public class SelectSkinDialog {
	 ...
	 */
	public void showDialog(List<String> data, int dialogTitleId, final Button button) {
		// 显示dialog
		dialog.show();
		// 加载并设置dialog中显示的布局
		...
		// 初始化listview中的数据
		final DialogSelectSkinListAdapter adapter = new DialogSelectSkinListAdapter(context, data);
		...
		dialogDataListview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				SysApplication.skinColor = adapter.getItem(position);
