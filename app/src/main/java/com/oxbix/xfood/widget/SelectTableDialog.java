...
import com.oxbix.xfood.adapter.DialogSelectTableListAdapter;
 ...
 */
public class SelectTableDialog {
	 ...
	 */
	public void showDialog(List<TableDTO> data, int dialogTitleId, final Button button) {
		// 显示dialog
		dialog.show();
		// 加载并设置dialog中显示的布局
		...
		// 初始化listview中的数据
		final DialogSelectTableListAdapter adapter = new DialogSelectTableListAdapter(context, data);
		...
		dialogDataListview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				SysApplication.currentTable = adapter.getItem(position);
